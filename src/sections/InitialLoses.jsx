  ...
  return (
    ...
    <div className="relative  flex  flex-col justify-center items-center w-full p-10" >
     ...
     <div className="relartive flex  w-full">
      ...
      severely damaged infrastructure. Oil and gas exports ground to a halt. 
     ...
     <div className="relartive flex  w-full">
      ...
      className=" relative font-montserrat text-slate-gray leading-8 space-y-1 ">
      <p>
      During 2015, the Central Bank of Yemen remained neutral and tried to ensure fiscal stability.
      ...
      and this <a href="https://www.undp.org/yemen/publications/assessing-impact-war-yemen-pathways-recovery" target="_blank" rel="noopener noreferrer" className='text-gray-800 underline'>loss has never been recovered</a>since. The Central Bank, 
      ...
      Many school buildings will be lost to shelling along the front line or used to house displaced people.
      </p>
      </article>
     </div>
