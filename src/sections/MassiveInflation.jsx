  ...
  <section id="home"
   ...
   <div className="relative  flex  flex-col justify-center items-center w-full p-10" >
     ...
     <div className="relartive flex  w-full">
      ...
      and general mistrust of the fragmented economy led to a severe deficit in the public budget. 
      ...
      <p>
      Gradually, many services and products were priced in hard currencies such as Saudi rials and U.S. 
