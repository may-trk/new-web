   ...
   className="flex flex-col justify-center gap-10  bg-red-50" >
    <div className="relative  flex  flex-col justify-center items-center w-full p-10" >
     ...
     <div className="relartive flex  w-full">
      ...
      More than half of Yemeni’s population today is <a href="https://news.un.org/en/story/2024/09/1154271" target="_blank" rel="noopener noreferrer" className='text-gray-800 underline'>dependent on aid.</a>
      </p>
      <p>
